...
class DefaultController extends AbstractController
{
     ...
     * @Route("/")
     */
    public function indexAction(Session $session, CommonGroundService $commonGroundService, MessageService $messageService, RequestService $requestService)
    {
...
//                    $variables['request']['properties']['ambtenaar'] = $commonGroundService->cleanUrl(['component'=>'pdc','type'=>'offers','id'=>'d5a657ff-846f-4d75-880c-abf4e9cb0c27']); // bestaat niet
...
//        if (!$slug && array_key_exists('request', $variables) && isset($variables['request']["currentStage"])) {
